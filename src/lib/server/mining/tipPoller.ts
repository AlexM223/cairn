/**
 * Chain-tip poller for the solo mining engine (adapted from the Tessera pool
 * TipPoller, C:\dev\raffle\pool\src\rpc.ts).
 *
 ...
 * params) }` RPC interface, which Cairn's CoreRpcClient satisfies directly.
 */
